...
CREATE TABLE IF NOT EXISTS `hi_ad` (
...
CREATE TABLE IF NOT EXISTS `hi_asset` (
...
CREATE TABLE IF NOT EXISTS `hi_auth_access` (
...
CREATE TABLE IF NOT EXISTS `hi_auth_rule` (
...
--
-- 转存表中的数据 `hi_auth_rule`
--

INSERT INTO `hi_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `hi_comments` (
...
--
-- 表的结构 `hi_common_action_log`
--

CREATE TABLE IF NOT EXISTS `hi_common_action_log` (
...
CREATE TABLE IF NOT EXISTS `hi_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hi_links` (
...
CREATE TABLE IF NOT EXISTS `hi_menu` (
...
INSERT INTO `hi_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `hi_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hi_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `hi_nav_cat` (
...
INSERT INTO `hi_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `hi_oauth_user` (
...
CREATE TABLE IF NOT EXISTS `hi_options` (
...
CREATE TABLE IF NOT EXISTS `hi_plugins` (
...
CREATE TABLE IF NOT EXISTS `hi_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hi_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `hi_role_user` (
...
CREATE TABLE IF NOT EXISTS `hi_route` (
...
CREATE TABLE IF NOT EXISTS `hi_slide` (
...
CREATE TABLE IF NOT EXISTS `hi_slide_cat` (
...
CREATE TABLE IF NOT EXISTS `hi_terms` (
...
INSERT INTO `hi_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
...
--
-- 表的结构 `hi_term_relationships`
--

CREATE TABLE IF NOT EXISTS `hi_term_relationships` (
...
INSERT INTO `hi_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
...
--
-- 表的结构 `hi_user_favorites`
--

CREATE TABLE IF NOT EXISTS `hi_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hi_variable` (
