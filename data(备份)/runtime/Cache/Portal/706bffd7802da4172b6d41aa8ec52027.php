...
<meta content="telephone=no" name="format-detection" />
  ...
  <link href="/themes/dongxingxijian/Public/assets/css/base.css" rel="stylesheet">
	<link href="/themes/dongxingxijian/Public/assets/css/style.css" rel="stylesheet">
		...
		<style>
			body{transition:all ease-in-out 2s;}
			.body-hide{opacity:0;}
			.wrapper{position: relative;z-index: 2;background-color:#d4d4dc;}
			.swiper-slide img{width:100%;}
			.swiper-pagination-bullet{background: #ffffff;}
			.swiper-pagination-bullet-active{background: #0b090a;}
		</style>
	</head>
...
<div class="instruction-contain"></div>
<?php $home_slides=sp_getslide("index_ads"); ?>
<div class="swiper-container">
    <div class="swiper-wrapper">
        <?php if(is_array($home_slides)): foreach($home_slides as $k=>$vo): ?><div class="swiper-slide">
...
<script>
  var mySwiper = new Swiper ('.swiper-container', {
	...
	$(".instruction-contain").addClass("get-in");
	setTimeout(function() {
		$(".instruction-contain").addClass("end-hide");
	},2000);
